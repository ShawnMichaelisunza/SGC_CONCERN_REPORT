            ...
            <div class="space-y-2 p-2">
                <div class="p-4 space-y-2 text-center dark:text-white">
                    ...
                    <p class="text-gray-500">
                        Are you sure you would like to reject this?
                    </p>
                </div>
            </div>
            ...
            <div class="space-y-2">
                ...
                <div class="px-6 py-2">
                    <div class="grid gap-1 grid-cols-[repeat(auto-fit,minmax(0,1fr))]">
                        <form action="{{ route('employee_destroy', encrypt($report->id)) }}" method="POST">
                            @csrf

                            @method('delete')
                            <button type="submit"
                                class="border border-red-300 bg-red-200 hover:bg-red-500 hover:text-white text-gray-700 py-2 px-8 rounded-md">
                                Confirm
                            </button>
                        </form>
                        <a href=""
                            class="border border-gray-300 hover:bg-gray-500 hover:text-white bg-gray-200 text-gray-700 py-2 px-6 rounded-md">
                            Cancel
                        </a>
                    </div>
                </div>
