            ...
            <div class="px-4 py-4">
                ...
                <div class="bg-white border-4 rounded-lg shadow relative m-6">
                    ...
                    <div class="p-6 space-y-6">
                        <form action="{{ route('employee_update', encrypt($report->id)) }}" method="POST">
                            @csrf
                            @method('put')
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <select name="company_name" id=""
                                        ...
                                        <option value="Head Office"
                                            {{ $report->company_name == 'Head Office' ? 'selected' : '' }}>Head Office
                                        </option>
                                        <option value="Redhotel Cubao"
                                            {{ $report->company_name == 'Redhotel Cubao' ? 'selected' : '' }}>Redhotel Cubao
                                        </option>
                                        <option value="Hotel99 Cubao"
                                            {{ $report->company_name == 'Hotel99 Cubao' ? 'selected' : '' }}>Hotel99 Cubao
                                        </option>
                                        <option value="Platinum Hotel Pasay"
                                            {{ $report->company_name == 'Platinum Hotel Pasay' ? 'selected' : '' }}>
                                            Platinum Hotel Pasay</option>
                                    </select>
                                    @error('company_name')
